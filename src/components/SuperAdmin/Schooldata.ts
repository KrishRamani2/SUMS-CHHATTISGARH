  ...
  states: [
    {
      ...
      "totalSchools": 450,
      "topSchools": [
        { "name": "JNV Raipur (Boys)", "attendance": 92.1 },
        { "name": "JNV Bilaspur (Girls)", "attendance": 84.7 },
        { "name": "JNV Durg (Boys)", "attendance": 81.5 },
        { "name": "JNV Korba (Girls)", "attendance": 79.3 },
        { "name": "Jawahar Navodaya Vidyalaya, Jagdalpur", "attendance": 78.6 }
      ],
      "districts": [
        {
          "name": "Raipur",
        ...
        },
        {
          ...
          "image": "School9",
          "topSchools": [
            { "name": "Delhi Public School Bilaspur", "attendance": 91.3 },
            { "name": "St. Xavier’s High School", "attendance": 88.9 },
            { "name": "DAV Public School", "attendance": 87.6 }
          ]
        },
        {
          "name": "Durg",
          ...
          "image": "School7",
          "topSchools": [
            { "name": "St. Thomas School", "attendance": 90.9 },
            { "name": "Holy Cross Senior Secondary School", "attendance": 89.2 },
            { "name": "Kendriya Vidyalaya Durg", "attendance": 87.8 }
          ]
        },
        {
          "name": "Korba",
          ...
          "image": "School11",
          "topSchools": [
            { "name": "Carmel Convent School", "attendance": 89.5 },
            { "name": "Oxford Public School", "attendance": 88.1 },
            { "name": "Guru Nanak Public School", "attendance": 86.7 }
          ]
        },
        {
          "name": "Jagdalpur",
          ...
          "image": "School10",
          "topSchools": [
            { "name": "St. Paul’s School", "attendance": 90.2 },
            { "name": "Modern Public School", "attendance": 88.4 },
            { "name": "DAV Model School", "attendance": 86.9 }
          ]
        }
      ]
    },    
