...
const schoolsData: School[] = [
  ...
  },
  {
    ...
    location: "Raipur",
    coordinates: "21.2335°N, 81.6502°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 890,
      total: 1000,
      percentage: 89.0,
      trend: [87, 88, 89, 90, 88, 91, 89.0],
      weeklyData: [
        { name: "Mon", attendance: 87 },
  ...
  // Durg District
  {
    ...
    location: "Bhilai",
    coordinates: "21.1860°N, 81.3509°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 918,
  ...
  },
  {
    ...
    location: "Durg",
    coordinates: "21.1904°N, 81.2849°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 880,
      total: 1000,
      percentage: 88.0,
      trend: [86, 87, 88, 89, 87, 90, 88.0],
      weeklyData: [
        { name: "Mon", attendance: 86 },
  ...
  // Bilaspur District
  {
    ...
    location: "Bilaspur",
    coordinates: "22.0796°N, 82.1391°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 905,
  ...
  },
  {
    ...
    location: "Bilaspur",
    coordinates: "22.0875°N, 82.1502°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 895,
  ...
  // Rajnandgaon District
  {
    ...
    coordinates: "21.0971°N, 81.0302°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 920,
  ...
  },
  {
    ...
    location: "Rajnandgaon",
    coordinates: "21.0882°N, 81.0355°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 885,
  ...
  // Korba District
  {
    ...
    name: "Carmel School",
    location: "Korba",
    coordinates: "22.3595°N, 82.7116°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 910,
  ...
  {
    id: 10,
    name: "Beacon English School",
    location: "Korba",
    coordinates: "22.3468°N, 82.6989°E",
    type: "Private",
    isActive: true,
    attendance: {
      present: 875,
