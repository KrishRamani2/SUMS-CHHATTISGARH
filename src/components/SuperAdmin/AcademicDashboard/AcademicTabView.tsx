  ...
  const schools: School[] = [
    {
      ...
      district: "Raipur",
      address: "Siltara, Raipur, Chhattisgarh 493111",
      attendance: "94.5%",
      academicScore: 92.8,
      progress: "Excellent",
      ...
      cctvStatus: "online",
      subjects: [
        { name: "Mathematics", score: 91, change: 5 },
        { name: "Science", score: 94, change: 4 },
        { name: "Language", score: 96, change: 3 }
      ]
    },
    {
      name: "Holy Cross Senior Secondary School, Bhilai",
      district: "Durg",
      address: "Sector 7, Bhilai, Durg, Chhattisgarh 490006",
      attendance: "91.0%",
      academicScore: 89.5,
      ...
      cctvStatus: "online",
      subjects: [
        { name: "Mathematics", score: 88, change: 4 },
        { name: "Science", score: 91, change: 3 },
        { name: "Language", score: 93, change: 2 }
      ]
    },
    {
      name: "DAV Public School, Bilaspur",
      district: "Bilaspur",
      address: "Vasant Vihar, Bilaspur, Chhattisgarh 495001",
      attendance: "89.8%",
      academicScore: 87.8,
      progress: "Good",
      lastAssessment: "Feb 15, 2025",
    ...
    {
      name: "Saraswati Shishu Mandir, Rajnandgaon",
      district: "Rajnandgaon",
      address: "Gandhi Nagar, Rajnandgaon, Chhattisgarh 491441",
      attendance: "88.5%",
      academicScore: 86.2,
      progress: "Good",
      lastAssessment: "Feb 15, 2025",
    ...
    {
      name: "Carmel School, Korba",
      district: "Korba",
      address: "Rampur, Korba, Chhattisgarh 495677",
      attendance: "87.3%",
      academicScore: 84.8,
      progress: "Average",
      lastAssessment: "Feb 15, 2025",
      cctvStatus: "online",
      subjects: [
        { name: "Mathematics", score: 81, change: 2 },
